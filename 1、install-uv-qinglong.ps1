...
$Env:UV_EXTRA_INDEX_URL = "https://download.pytorch.org/whl/cu116"
...
huggingface-cli download stabilityai/stable-video-diffusion-img2vid-xt --local-dir pretrained_weights/stable-video-diffusion-img2vid-xt --exclude "*.safetensors"

huggingface-cli download stabilityai/stable-video-diffusion-img2vid-xt --local-dir pretrained_weights/stable-video-diffusion-img2vid-xt --include "*.fp16.safetensors"

huggingface-cli download Yhmeng1106/anidoc --local-dir pretrained_weights/

huggingface-cli download facebook/cotracker --local-dir pretrained_weights/
